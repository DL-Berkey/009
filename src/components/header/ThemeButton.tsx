    ...
    return (
        <>
            ...
            >
                ...
                <span className="absolute w-1/2 h-full transition-all duration-500 translate-x-full -translate-y-1/2 bg-blue-500 rounded peer-checked:translate-x-0 top-1/2"></span>
            </label>
        </>
    );
};
